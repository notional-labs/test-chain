...
import (
	...
	"github.com/notional-labs/test-chain2/docs"
...
type App struct {
	*baseapp.BaseApp
	...
	Testchain2Keeper testchain2modulekeeper.Keeper
...
func New(
	...
	app.Testchain2Keeper = *testchain2modulekeeper.NewKeeper(
		appCodec,
		keys[testchain2moduletypes.StoreKey],
		keys[testchain2moduletypes.MemStoreKey],
	)
	testchain2Module := testchain2module.NewAppModule(appCodec, app.Testchain2Keeper)
